...
class ApiRequestor
{
     ...
     * @throws Exception\OAuth\InvalidClientException
     * @throws Exception\OAuth\InvalidGrantException
     * @throws Exception\OAuth\InvalidRequestException
     * @throws Exception\OAuth\InvalidScopeException
     * @throws Exception\OAuth\UnsupportedGrantTypeException
     * @throws Exception\OAuth\UnsupportedResponseTypeException
     ...
     *    permissions.
     * @throws Exception\CardException if the error is the error code is 402 (payment
     *    required)
     * @throws Exception\InvalidRequestException if the error is caused by the user.
     * @throws Exception\IdempotencyException if the error is caused by an idempotency key.
     * @throws Exception\OAuth\InvalidClientException
     * @throws Exception\OAuth\InvalidGrantException
     * @throws Exception\OAuth\InvalidRequestException
     * @throws Exception\OAuth\InvalidScopeException
     ...
     * @throws Exception\PermissionException if the error is caused by insufficient
     *    permissions.
     * @throws Exception\RateLimitException if the error is caused by too many requests
     *    hitting the API.
    ...
    private static function _specificAPIError($rbody, $rcode, $rheaders, $resp, $errorData)
    {
        ...
        switch ($rcode) {
            ...
            case 429:
                return Exception\RateLimitException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code, $param);
            default:
                return Exception\ApiException::factory($msg, $rcode, $rbody, $resp, $rheaders, $code);
        }
    }
     ...
     *
     * @return null|Exception\OAuth\ExceptionInterface
     */
